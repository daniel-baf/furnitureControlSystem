                                        ...
                                        <form class="user" action="${pageContext.request.contextPath}/Login" method="POST">
                                            <div class="form-group">
                                                <input type="user" class="form-control form-control-user"
                                                       ...
                                                       placeholder="Escribe tu usuario" name="user">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <button class="btn btn-primary btn-user btn-block" type="submit">Logearme</button>
                                            <hr>
                                            <a href="#" class="btn btn-google btn-user btn-block">
                                                <i class="fab fa-google fa-fw"></i> Recibe el inventario en PDF
                                            </a>
