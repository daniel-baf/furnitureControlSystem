                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <p>Presiona los 3 puntos para cambiar de ventana</p>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="chart-area">
                                                ...
                                                <div id="insert-frn-FAAP">
                                                    <h6 class="row d-flex p-2 justify-content-center border-bottom-primary">Disponibilidad Muebles</h6>
                                                    <div class="m-0 row justify-content-center">
                                                        <div class="form-group">
                                                            <label for="exampleInputName">Ver los muebles disponibles para la venta</label>
                                                            <a class="btn btn-block btn-primary" href="${pageContext.request.contextPath}/SelectFromDB?show-obj-value=select-available-furns">Ver muebles</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- FURNITURE END -->
